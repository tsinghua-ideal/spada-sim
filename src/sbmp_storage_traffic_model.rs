...
impl<'a> TrafficModel<'a> {
    ...
    fn fetch_window_data(
        ...
        // let current_cache = self.fiber_cache.rowmap
        //     .keys()
        //     .map(|r| [*r, self.fiber_cache.valid_pq_row_dict[r]])
        //     .sorted_by_key(|x|x[1])
        //     .collect::<Vec<[usize; 2]>>();
        // println!("Current cache: {:?}", &current_cache);
        // println!("pe.row_s: {} pe.col_s: {}", pe.row_s, pe.col_s);
